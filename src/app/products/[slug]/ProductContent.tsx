...
import { Product } from '@/lib/dataUtils';
...
export default function ProductContent({ product }: ProductContentProps) {
  ...
  return (
    <>
      ...
      {/* Notable Observations Section - Placed after product details */}
      {Array.isArray(product.notableObservations) && product.notableObservations.length > 0 && (
        <div className="mb-6 pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <ul className="space-y-3 list-disc list-inside text-gray-700 dark:text-gray-300">
            {product.notableObservations.map((observation, index) => (
      ...
      {Array.isArray(product.unexpectedInsights) && product.unexpectedInsights.length > 0 && (
        <div className="mb-6 pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <ul className="space-y-3 list-disc list-inside text-gray-700 dark:text-gray-300">
            {product.unexpectedInsights.map((insight, index) => (
      ...
      {(Array.isArray(product.topics) && product.topics.length > 0) ||
