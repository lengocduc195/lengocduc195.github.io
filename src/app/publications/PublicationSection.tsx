...
import type { Publication } from '@/lib/dataUtils';
...
export default function PublicationSection({
  ...
  const filteredAndSortedPublications = useMemo(() => {
    // Đảm bảo publications là một mảng
    ...
    return filtered;
  }, [publications, searchTerm, sortCriteria, lowerYourName, rankOrder]);

  return (
    <div className="mb-12 bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
      {/* Section Header */}
      <div
        className="bg-gradient-to-r from-green-600 to-teal-600 p-4 flex justify-between items-center cursor-pointer"
        onClick={() => setIsExpanded(!isExpanded)}
      >
        <h2 className="text-xl font-bold text-white flex items-center">
          {sectionTitle}
          <span className="ml-3 bg-white/20 text-white text-sm font-medium px-2.5 py-0.5 rounded-full">
            {publications.length}
          </span>
        </h2>
      ...
      {isExpanded && (
        <div className="p-6">
          ...
          <div className="mb-6 flex flex-col md:flex-row md:items-center gap-4 bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
            <div className="flex-grow relative">
              ...
              <input
                type="text"
                placeholder={`Search ${sectionTitle} publications...`}
                value={searchTerm}
          ...
          {filteredAndSortedPublications.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-3">No publications match your criteria</p>
              <button
                onClick={() => setSearchTerm('')}
            ...
            <div>
              ...
              <ul className="space-y-6">
                {filteredAndSortedPublications.map((pub) => {
                  ...
                  return (
                    <li key={itemKey} className="group bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-green-300 dark:hover:border-green-700 transform hover:-translate-y-1">
                      <div className="p-6">
